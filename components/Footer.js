...
export default function Footer() {
  return (
    <footer className="w-full bg-[#141C3A] text-white pt-12 pb-6 mb-6 px-6 md:px-12 lg:px-24 rounded-b-[2rem]">
      <div className="max-w-7xl mx-auto">
        
        {/* Top Section: Info, Links, and Socials */}
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-10 mb-8">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-gray-300 text-base">
              Email: digroz59@gmail.com
            </p>
          </div>

          {/* Center Column: Navigation Links */}
          <nav className="flex flex-col items-start md:items-center gap-3">
        ...
        {/* Divider */}
        <hr className="border-t border-gray-700/60 mb-6" />
